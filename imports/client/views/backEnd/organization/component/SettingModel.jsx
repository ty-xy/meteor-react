            ...
            >
                <Form onSubmit={this.handleDepSetting}>
                    ...
                    <div className="text-center form-buttom">
                        ...
                        <div className="margin-top-20"><Button type="danger" style={{ width: '150px', background: '#EF5350', color: '#fff', borderColor: '#EF5350' }} onClick={() => handleDepDel(data.id, data.groupId)}>删除</Button></div>
                    </div>
                </Form>
            </MyModel>
        );
